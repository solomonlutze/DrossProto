...
public class AggroAiAction : MoveAiAction
{
  ...
  public override bool OnEntry(AiStateController controller)
  {
    ...
    float attackRoll = Random.Range(0f, basicAttackWeight + blockAttackWeight + powerAttackWeight + critAttackWeight);
    ...
    else if (attackRoll < basicAttackWeight + blockAttackWeight + powerAttackWeight)
    {
