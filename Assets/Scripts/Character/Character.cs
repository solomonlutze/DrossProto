...
public class Character : WorldObject
{
  ...
  public IEnumerator UseCritAttack()
  {
    ...
    victim.orientation.rotation = GetDirectionAngle(transform.position);
  ...
  {
    Debug.Log("damageSource - isOwnedBy(this):" + damageSource.IsOwnedBy(this));
    Debug.Log("damageSource - IsSameOwnerType(this):" + damageSource.IsSameOwnerType(this));
    Debug.Log("(damageSource.isCritAttack && !damageSource.IsOwnedBy(critVictimOf):" + (damageSource.isCritAttack && !damageSource.IsOwnedBy(critVictimOf)));
    Debug.Break();
