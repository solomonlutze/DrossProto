...
public class Character : WorldObject
{
    ...
    public Character isCritVictimOf = null; // true while subject to crit attack
    ...
    public bool InCrit()
    {
        return usingCrit || isCritVictimOf != null;
    }

    public void SetCritVictim(Character c)
    {
        isCritVictimOf = c;
    }
    ...
    protected virtual void TakeDamage(IDamageSource damageSource)
    {
        ...
        if (usingCrit || (isCritVictimOf && !damageSource.IsOwnedBy(isCritVictimOf))) { return; }
        if (
