    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) 
    {
        ...
        switch (traitEffectType)
        {
            case TraitEffectType.Resistance:
                ...
                break;
            case TraitEffectType.TileHeightLevel:
                Rect tileHeightRect = new Rect(position.x, position.y + EditorGUIUtility.singleLineHeight, position.width, EditorGUIUtility.singleLineHeight);
                EditorGUI.PropertyField(tileHeightRect, property.FindPropertyRelative("tileHeightLevel"), new GUIContent("Tile Height: "));
                break;
            case TraitEffectType.AnimationInput:
            ...
            case TraitEffectType.CharacterStat:
                ...
                EditorGUI.PropertyField(statRect, property.FindPropertyRelative("damageType"), new GUIContent("Stat: "));
