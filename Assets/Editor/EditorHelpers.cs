...
public static class EditorHelpers
{
  ...
  [MenuItem("CustomTools/ToggleDebug")]
  private static void ToggleDebug()
  {
    GameMaster.Instance.DebugEnabled = !GameMaster.Instance.DebugEnabled;
    Debug.Log("DebugEnabled is now " + GameMaster.Instance.DebugEnabled);
  }
